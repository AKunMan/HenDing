...
@objc protocol HXPageViewControllerDataSource: class {
    ...
    func pageViewController(_ pageViewController: HXPageViewController, titleForItemAt index: Int) -> HDWarningModel
...
class HXPageViewController: UIViewController {
    ...
    func setSelectedIndex(index: Int, shouldHandleContentScrollView flag: Bool) {
        pageTabBar.setSelectedIndex(index, shouldHandleContentScrollView: flag)
    }
    ...
    func preferredTitleForItem(at index: Int) -> HDWarningModel {
        return dataSource?.pageViewController(self, titleForItemAt: index) ?? HDWarningModel()
    }
