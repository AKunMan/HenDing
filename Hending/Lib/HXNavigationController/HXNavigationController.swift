...
class HXNavigationController: UINavigationController {
    ...
    override func setNavigationBarHidden(_ hidden: Bool, animated: Bool) {
        ...
        if hidden {
            self.topViewController?.hx_barAlpha = 0
            self.topViewController?.hx_tintColor = .clear
            self.topViewController?.hx_titleColor = .clear
            self.topViewController?.hx_barStyle = .default
        }
    }
